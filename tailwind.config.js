...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        neon: '0 1px 2px rgba(20, 30, 25, 0.08)',
        'neon-sm': '0 1px 2px rgba(20, 30, 25, 0.06)',
        'neon-lg': '0 2px 8px rgba(20, 30, 25, 0.10)',
        'neon-intense': '0 2px 8px rgba(20, 30, 25, 0.10)',
        glass: '0 1px 2px rgba(20, 30, 25, 0.06)',
        'glass-lg': '0 2px 8px rgba(20, 30, 25, 0.08)',
        'glass-xl': '0 4px 16px rgba(20, 30, 25, 0.10)',
      },
      backdropBlur: {
        xs: '2px',
      },
