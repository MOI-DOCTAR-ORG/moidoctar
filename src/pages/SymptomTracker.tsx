...
export default function SymptomTracker() {
  ...
  const handleSaveEntry = () => {
    ...
    const classes: Record<string, { severityClass: string, dotClass: string }> = {
      Mild: { severityClass: 'bg-primary/15 text-primary border border-primary/20', dotClass: 'bg-primary' },
  ...
  return (
    <main className="min-h-screen p-4 md:p-6 max-w-[1200px] mx-auto font-body-md bg-surface">
      <header className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 bg-surface p-2 rounded-xl border border-outline-variant">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <section className="lg:col-span-12 bg-surface rounded-[16px] border border-outline-variant p-6 md:p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-full bg-primary/15 flex items-center justify-center text-primary border border-primary/20">
                ...
                {['Mild', 'Moderate', 'Severe'].map((s) => (
                  <button
                    ...
                    className={
                      ...
                      (severity === s
                        ? 'bg-primary text-on-primary border-primary shadow-lg/20'
          ...
          <div className="mt-8 flex justify-end">
            <button onClick={handleSaveEntry} className="w-full sm:w-auto bg-primary text-on-primary font-label-md px-6 md:px-8 py-3 md:py-4 rounded-full hover:opacity-90 transition-transform active:scale-95 flex items-center justify-center gap-2 shadow-lg/20 min-h-[44px]">
        ...
        <section className="lg:col-span-8 bg-surface rounded-[16px] border border-outline-variant p-6 md:p-8 flex flex-col">
        ...
        <section className="lg:col-span-4 bg-surface rounded-[16px] border border-outline-variant overflow-hidden flex flex-col">
        ...
        <section onClick={() => navigate('/symptom-tracker-body-map')} className="lg:col-span-12 relative h-56 rounded-[16px] overflow-hidden group cursor-pointer bg-surface border border-outline-variant">
          ...
          />
          <div className="absolute inset-0 bg-surface/95 flex items-center p-6 z-10">
